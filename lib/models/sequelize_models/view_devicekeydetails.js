      ...
      keyStatus: {
        ...
        get: function() {
          ...
          function validKeyDate(dateDetails) {
            ...
            else if (currentDateTime.date >= dateStart && dateEnd === '0000-00-00') return true;
            else return (currentDateTime.date >= dateStart && currentDateTime.date < dateEnd);
          }
          ...
          if (accessExpirationDate) accessExpirationDate = moment(accessExpirationDate).format('YYYY-MM-DD');
          else accessExpirationDate = '0000-00-00'
          if (accessActivationDate) accessActivationDate = moment(accessActivationDate).format('YYYY-MM-DD');
          else accessActivationDate = '0000-00-00'
